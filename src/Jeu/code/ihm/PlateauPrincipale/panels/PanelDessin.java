...
public class PanelDessin extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		System.out.println(graphics2D.drawImage(this.getToolkit().getImage("./code/images/distrib_images_2/Plateau_vierge.png"), 0, 0, this.getWidth(), this.getHeight(), this));
